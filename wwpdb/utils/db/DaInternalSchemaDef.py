...
class DaInternalSchemaDef(SchemaDefBase):
    ...
    _schemaDefDict = {
        ...
        'EM_AUTHOR_LIST': {'ATTRIBUTES': {'IDENTIFIER_ORCID': 'identifier_ORCID',
                                          'AUTHOR': 'author',
                                          'ORDINAL': 'ordinal',
                                          'STRUCTURE_ID': 'Structure_ID'},
                           'ATTRIBUTE_INFO': {'IDENTIFIER_ORCID': {'NULLABLE': True,
                                              ...
                                              'STRUCTURE_ID': {'NULLABLE': False,
                                                               ...
                                                               'SQL_TYPE': 'VARCHAR',
                                                               'WIDTH': 15}},
                           'ATTRIBUTE_MAP': {'IDENTIFIER_ORCID': ('em_author_list', 'identifier_ORCID', None, None),
                                             'AUTHOR': ('em_author_list', 'author', None, None),
                                             'ORDINAL': ('em_author_list', 'ordinal', None, None),
                                             'STRUCTURE_ID': (None, None, 'datablockid()', None)},
                           'INDICES': {'p1': {'ATTRIBUTES': ('STRUCTURE_ID', 'NAME', 'ORDINAL'), 'TYPE': 'UNIQUE'},
                                       's1': {'ATTRIBUTES': ('STRUCTURE_ID',), 'TYPE': 'SEARCH'}},
                           'MAP_MERGE_INDICES': {
                               'em_author_list': {'ATTRIBUTES': ('name', 'ordinal'), 'TYPE': 'EQUI-JOIN'}},
                           'TABLE_DELETE_ATTRIBUTE': 'STRUCTURE_ID',
        ...
        'EM_DEPUI': {'ATTRIBUTES': {'DEPOSITOR_HOLD_INSTRUCTIONS': 'depositor_hold_instructions',
                                    'MACROMOLECULAR_DESCRIPTION': 'macromolecular_description',
                     ...
                     'ATTRIBUTE_INFO': {'DEPOSITOR_HOLD_INSTRUCTIONS': {'NULLABLE': True,
                                                                        ...
                                                                        'SQL_TYPE': 'VARCHAR',
                                                                        'WIDTH': 80},
                                        'MACROMOLECULAR_DESCRIPTION': {'NULLABLE': True,
                                                                       'ORDER': 3,
                                                                       'PRECISION': 0,
                                                                       'PRIMARY_KEY': False,
                                                                       'SQL_TYPE': 'VARCHAR',
                                        ...
                                        'STRUCTURE_ID': {'NULLABLE': False,
                                                         ...
                                                         'SQL_TYPE': 'VARCHAR',
                                                         'WIDTH': 15}},
                     'ATTRIBUTE_MAP': {'IDENTIFIER_ORCID': ('em_depui', 'identifier_ORCID', None, None),
                                       'AUTHOR': ('em_depui', 'author', None, None),
                                       'ORDINAL': ('em_depui', 'ordinal', None, None),
                                       'STRUCTURE_ID': (None, None, 'datablockid()', None)},
                     'INDICES': {'p1': {'ATTRIBUTES': ('STRUCTURE_ID', 'NAME', 'ORDINAL'), 'TYPE': 'UNIQUE'},
                                 's1': {'ATTRIBUTES': ('STRUCTURE_ID',), 'TYPE': 'SEARCH'}},
                     'MAP_MERGE_INDICES': {
                         'em_depui': {'ATTRIBUTES': ('name', 'ordinal'), 'TYPE': 'EQUI-JOIN'}},
                     'TABLE_DELETE_ATTRIBUTE': 'STRUCTURE_ID',
                     'TABLE_ID': 'EM_DEPUI',
                     'TABLE_NAME': 'em_depui',
                     'TABLE_TYPE': 'transactional'},
